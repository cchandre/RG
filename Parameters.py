...
Ncs = 10 # number of points on the critical surface
Kindx = (0, 1) # indices of K for which the critical surface is computed
TolCS = 1e-6
...
if Case == 'GoldenMean':
    ...
    KampInf = [0.005, 0.055, 0.1]
    KampSup = [0.15, 0.11, 0.1]
